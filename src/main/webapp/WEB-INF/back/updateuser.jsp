...
<body>
	...
	<div id="addAll">
		...
		<div id="table">
			<form action="${pageContext.request.contextPath}/updateuser" method="post" id="myform">
				
				<input type="hidden" name="uid" class="two" value="${u.uid }"><table>
					<tr>
						<td class="three">用户头像</td>
						<td><br>
							<div id="imgDiv" style="display: block; width: 40px; height: 50px;">
								<img src="${pageContext.request.contextPath}/resources/image_user/${u.uimage}" width="100px" height="100px">
							</div>
							<br><br> <br> <br> 
					...
					<tr>
						<td class="one">密码</td>
						<td><input type="password" name="upass" value="${u.upass}"
							class="two"></td>
					</tr>
					<!--错误提示-->
					<tr class="three">
					...
					<tr>
						<td class="one">性别</td>
						<td><input type="text" name="usex" value="${u.usex }"
							class="two"></td>
					</tr>
					<!--错误提示-->
					<tr class="three">
					...
					<tr>
						<td class="one">年龄</td>
						<td><input type="number" name="uage" value="${u.uage }"
							class="two"></td>
					</tr>
					<!--错误提示-->
					<tr class="three">
					...
					<tr>
						...
						<td><input type="text" name="udepartment"
							value="${u.udepartment }" class="two"></td>
					</tr>
					<!--错误提示-->
					<tr class="three">
						<td class="four"></td>
					...
					<tr>
						...
						<td><input type="text" name="realname" value="${u.realname }"
							class="two"></td>
					</tr>
					<!--错误提示-->
					<tr class="three">
