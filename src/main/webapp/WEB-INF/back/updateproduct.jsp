	...
	<div id="addAll">
		...
		<div id="table">
			<form action="${pageContext.request.contextPath}/updateproduct"
				...
				<input type="hidden" name="id" class="two" value="${prod.id }">
				<table>
					<tr>
					...
					<tr>
						...
						<td><input type="text" name="content"
							value="${prod.content }" class="two"></td>
					</tr>
					<!--错误提示-->
					<tr class="three">
						<td class="four"></td>
					...
					<tr>
						...
						<td><br>
							<div id="imgDiv"
								...
								<img
									src="${pageContext.request.contextPath}/resources/image_big/${prod.image}"
					...
					<tr>
						...
						<td><input type="number" name="number"
							value="${prod.number }" class="two"></td>
					</tr>
					<!--错误提示-->
					<tr class="three">
						<td class="four"></td>
