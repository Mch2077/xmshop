...
<html>
	...
	<body>
		<div id="login">
			<div id="top">
				<img src="${pageContext.request.contextPath}/resources/images/cloud.jpg" /><span>REGIST</span>
			</div>
			<div id="bottom">
				<form action="${pageContext.request.contextPath}/admin/main.jsp" method="get">
