...
<html>
	...
	<!--取出上一个页面上带来的page的值-->
		...
		<div id="addAll">
			...
			<div id="table">
				<form action="${pageContext.request.contextPath}/updatenote"  method="post" id="myform">
				<input type="hidden" name="id" class="two" value="${note.id }">
					<table>
						<tr>
							<td class="one">标题</td>
							<td><input type="text" name="title" class="two" value="${note.title }"></td>
						</tr>
						<!--错误提示-->
						<tr class="three">
							<td class="four"></td>
						...
						<tr>
							...
							<td><input type="text" name="content" class="two" value="${note.content }"></td>
						</tr>
						<!--错误提示-->
						<tr class="three">
							<td class="four"></td>
						...
						<tr>
							<td class="one">作者</td>
							<td><input type="text" name="publisher" readonly class="two" value="${sessionScope.user.uname}"></td>
						</tr>
						<!--错误提示-->
						<tr class="three">
							<td class="four"></td>
